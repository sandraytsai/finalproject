...
menu.prototype = {
  ...
  create: function(){
    ...
    var playButton1 = this.game.add.button(160, 320, "bullet",
      this.playFirstGame, this);

    playButton1.anchor.setTo(0.5,0.5);


    var playButton2 = this.game.add.button(200,320,"diamond",
      this.playSecondGame,this);
